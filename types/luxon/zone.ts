 ...
 */
export declare class IANAZone extends Zone {
    /**
 ...
 */
export declare class FixedOffsetZone extends Zone {
    /**
 ...
 */
export declare class InvalidZone extends Zone {}

/**
 * Represents the system zone for this JavaScript environment.
 */
export declare class SystemZone extends Zone {
    /**
