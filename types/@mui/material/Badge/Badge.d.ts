...
export declare type BadgeTypeMap<D extends React.ElementType = 'span', P = {}> = ExtendBadgeUnstyledTypeMap<{
    props: P & {
        /**
...
declare type BadgeRootProps = NonNullable<BadgeTypeMap['props']['componentsProps']>['root'];
declare type BadgeBadgeProps = NonNullable<BadgeTypeMap['props']['componentsProps']>['badge'];
export declare const BadgeRoot: React.FC<BadgeRootProps>;
export declare const BadgeMark: React.FC<BadgeBadgeProps>;
export declare type BadgeClassKey = keyof NonNullable<BadgeTypeMap['props']['classes']>;
/**
 *
 * Demos:
 *
...
export declare type BadgeClasses = Record<BadgeClassKey, string>;
export declare const badgeClasses: BadgeClasses;
export declare type BadgeProps<D extends React.ElementType = BadgeTypeMap['defaultComponent'], P = {}> = OverrideProps<BadgeTypeMap<D, P>, D>;
