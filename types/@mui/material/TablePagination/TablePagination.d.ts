...
export declare type TablePaginationBaseProps = Omit<TableCellProps, 'classes' | 'component' | 'children'>;
export declare type TablePaginationProps<D extends React.ElementType = React.JSXElementConstructor<TablePaginationBaseProps>, P = {}> = OverrideProps<TablePaginationTypeMap<P, D>, D>;
