...
export declare type ButtonTypeMap<P = {}, D extends React.ElementType = 'button'> = ExtendButtonBaseTypeMap<{
    props: P & {
        /**
...
export declare type ExtendButton<M extends OverridableTypeMap> = ((props: {
    href: string;
...
export declare type ButtonProps<D extends React.ElementType = ButtonTypeMap['defaultComponent'], P = {}> = OverrideProps<ButtonTypeMap<P, D>, D>;
