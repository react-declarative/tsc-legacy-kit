...
export declare type ExtendButtonBase<M extends OverridableTypeMap> = ((props: {
    href: string;
...
export declare type ButtonBaseProps<D extends React.ElementType = ButtonBaseTypeMap['defaultComponent'], P = {}> = OverrideProps<ButtonBaseTypeMap<P, D>, D>;
