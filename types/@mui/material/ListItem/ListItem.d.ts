 ...
 */
declare const ListItem: ExtendButtonBase<ListItemTypeMap<{
    /**
...
export declare type ListItemProps<D extends React.ElementType = 'li', P = {}> = OverrideProps<ListItemTypeMap<P, D>, D>;
