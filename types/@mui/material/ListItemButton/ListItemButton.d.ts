...
export declare type ListItemButtonTypeMap<P = {}, D extends React.ElementType = 'div'> = ExtendButtonBaseTypeMap<{
...
export declare type ListItemButtonProps<D extends React.ElementType = ListItemButtonTypeMap['defaultComponent'], P = {}> = OverrideProps<ListItemButtonTypeMap<P, D>, D>;
