...
export declare function createFilterOptions<T>(config?: CreateFilterOptionsConfig<T>): (options: T[], state: FilterOptionsState<T>) => T[];
export declare type AutocompleteFreeSoloValueMapping<FreeSolo> = FreeSolo extends true ? string : never;
export declare type AutocompleteValue<T, Multiple, DisableClearable, FreeSolo> = Multiple extends undefined | false ? DisableClearable extends true ? NonNullable<T | AutocompleteFreeSoloValueMapping<FreeSolo>> : T | null | AutocompleteFreeSoloValueMapping<FreeSolo> : Array<T | AutocompleteFreeSoloValueMapping<FreeSolo>>;
...
export declare type AutocompleteHighlightChangeReason = 'keyboard' | 'mouse' | 'auto';
export declare type AutocompleteChangeReason = 'createOption' | 'selectOption' | 'removeOption' | 'clear' | 'blur';
export interface AutocompleteChangeDetails<T = string> {
    option: T;
}
export declare type AutocompleteCloseReason = 'createOption' | 'toggleInput' | 'escape' | 'selectOption' | 'removeOption' | 'blur';
export declare type AutocompleteInputChangeReason = 'input' | 'reset' | 'clear';
export declare type AutocompleteGetTagProps = ({ index }: {
    index: number;
}) => {
    key: number;
...
export declare type useAutocomplete = <T, Multiple extends boolean | undefined = undefined, DisableClearable extends boolean | undefined = undefined, FreeSolo extends boolean | undefined = undefined>(props: UseAutocompleteProps<T, Multiple, DisableClearable, FreeSolo>) => {
