...
export declare type ExtendBackdropUnstyled<M extends OverridableTypeMap> = OverridableComponent<ExtendBackdropUnstyledTypeMap<M>>;
/**
 *
 * Demos:
 *
...
export declare type BackdropUnstyledProps<D extends React.ElementType = BackdropUnstyledTypeMap['defaultComponent'], P = {}> = OverrideProps<BackdropUnstyledTypeMap<P, D>, D>;
