...
export declare type TabListClassKey = keyof NonNullable<TabListTypeMap['props']['classes']>;
export declare type TabListProps<D extends React.ElementType = TabListTypeMap['defaultComponent'], P = {}> = OverrideProps<TabListTypeMap<P, D>, D>;
