...
export declare function createUnarySpacing<Spacing>(theme: { spacing: Spacing }): Spacing extends number
...
export declare const margin: SimpleStyleFunction<
  | 'm'
  | 'mt'
  | 'mr'
  | 'mb'
...
export declare const padding: SimpleStyleFunction<
  | 'p'
  | 'pt'
  | 'pr'
  | 'pb'
