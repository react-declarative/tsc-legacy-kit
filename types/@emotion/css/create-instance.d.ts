...
export { CSSInterpolation, ArrayCSSInterpolation, ComponentSelector, CSSObject } from '@emotion/serialize';
...
export declare type createEmotion = (options?: Options) => Emotion;
