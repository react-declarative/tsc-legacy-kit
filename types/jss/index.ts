...
export declare function create(options?: Partial<JssOptions>): Jss
export declare const createGenerateId: CreateGenerateId
export declare function createRule<D>(name: string, decl: JssStyle, options: RuleOptions): Rule
export declare function toCssValue(value: JssValue, ignoreImportant: boolean): string
export declare function getDynamicStyles(styles: Styles): Styles | null
