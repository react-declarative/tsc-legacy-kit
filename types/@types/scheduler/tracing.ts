...
export declare const __interactionsRef: IfSchedulerTracing<InteractionsRef, null>;
export declare const __subscriberRef: IfSchedulerTracing<SubscriberRef, null>;

export declare function unstable_clear<T>(callback: () => T): T;

export declare function unstable_getCurrent(): Set<Interaction> | null;

export declare function unstable_getThreadID(): number;

export declare function unstable_trace<T>(
  name: string,
  timestamp: number,
  callback: () => T,
  threadID?: number
 ...
 * @param threadID
 */
export declare function unstable_wrap<T extends (...args: any[]) => any>(
  callback: T,
  threadID?: number
): IfSchedulerTracing<WrappedFunction<T>, T>;

export declare function unstable_subscribe(subscriber: Subscriber): void;

export declare function unstable_unsubscribe(subscriber: Subscriber): void;
