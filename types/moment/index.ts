...
declare namespace moment {
  ...
  export declare namespace unitOfTime {
    type Base = (
      "year" | "years" | "y" |
      "month" | "months" | "M" |
      "week" | "weeks" | "w" |
  ...
  export declare function locale(language?: string[]): string;
  export declare function locale(language?: string, definition?: LocaleSpecification | void): string; // null | undefined
  ...
  export declare function defineLocale(language: string, localeSpec: LocaleSpecification | void): Locale; // null
  export declare function updateLocale(language: string, localeSpec: LocaleSpecification | void): Locale; // null
   ...
   */
  export declare var ISO_8601: MomentBuiltinFormat;
  export declare var RFC_2822: MomentBuiltinFormat;

  export declare var defaultFormat: string;
  export declare var defaultFormatUtc: string;
  export declare var suppressDeprecationWarnings: boolean;
  export declare var deprecationHandler: ((name: string | void, msg: string) => void) | void;

  export declare var HTML5_FMT: {
